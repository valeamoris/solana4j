...
final class SendTransactionContractTest extends SolanaClientIntegrationTestBase {
    ...
    void beforeEach() throws SolanaJsonRpcClientException {
        ...
        signers.add(new Solana4jJsonRpcTestHelper.Signer(Solana.account(PAYER), SolanaEncoding.decodeBase58(PAYER_PRIV)));
        signers.add(new Solana4jJsonRpcTestHelper.Signer(Solana.account(TOKEN_ACCOUNT_OWNER), SolanaEncoding.decodeBase58(TOKEN_ACCOUNT_OWNER_PRIV)));
    ...
    void shouldReturnErrorForMinContextSlotNotReached() throws SolanaJsonRpcClientException {
        ...
        final SolanaClientResponse<String> response = SOLANA_API.sendTransaction(successfulTransactionBlobBase64, optionalParams);
