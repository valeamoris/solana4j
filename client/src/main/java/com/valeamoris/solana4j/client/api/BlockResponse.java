...
public interface BlockResponse {
    ...
    interface TransactionData
    {
         ...
         *
         * @return the {@link TransactionResponse.TransactionData.TransactionDataParsed} object representing the parsed transaction data
         */
    ...
    interface Message
    {
        ...
        interface AccountKeys
        {
            ...
            interface AccountKeyParsed
            {
                 ...
                 *
                 * @return the source of the account key, either {@link KeySource#TRANSACTION} or {@link TransactionResponse.Message.AccountKeys.AccountKeyParsed.KeySource#LOOKUPTABLE}
                 */
                KeySource getSource();
